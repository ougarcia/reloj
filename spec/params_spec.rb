...
describe Reloj::Params do
  ...
  it "handles an empty request" do
    expect { Reloj::Params.new(req) }.to_not raise_error
  end

  context "query string" do
    it "handles single key and value" do
      req.query_string = "key=val"
      params = Reloj::Params.new(req)
  ...
  context "route params" do
    it "handles route params" do
      params = Reloj::Params.new(req, {"id" => 5, "user_id" => 22})
  ...
  context "indifferent access" do
    it "responds to string and symbol keys" do
      params = Reloj::Params.new(req, {"id" => 5})
      expect(params["id"]).to eq(5)
      expect(params[:id]).to eq(5)
    end
  end
  ...
  #       expect { params.require("key2") }.to raise_error(Reloj::Params::AttributeNotFoundError)
  #     end
  #   end
  #
